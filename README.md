...
```bash
git clone --recurse-submodules https://github.com/bangyen/leanbf.git
cd leanbf
...
for example, completing the `jzdec` translation or taking a first step toward
the completeness proof — feel free to open a pull request.
